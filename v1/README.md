...
2. Use the [Iconifiy Icons Module](#iconify-icons-module) (requires the setup of the [Iconify Icons Framework](https://github.com/stadium-software/icons) in the application)
